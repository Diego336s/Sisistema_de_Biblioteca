                ...
                <div class="col-md-6 p-md-3 mb-4 rounded text-body-emphasis bg-body-secondary">
                    ...
                    <%
                        if (request.getMethod().equals("POST")) {
                            ...
                            Libro newLibro = null;
                            int id = administrador.getAuementoLibroId();
                            ...
                            if (tipoLibro.equals("Ficcion") ) {
                                ...
                                newLibro = new LibroFiccion(id, nombre, tipoLibro, autor, genero,  premiosLiterarios);
                            } else if (tipoLibro.equals("No Ficcion")) {
                                String genero = request.getParameter("genero");

                                String premiosLiterarios = request.getParameter("premios");
                                String areaTematica = request.getParameter("areaTematica");
                                String tipoPublico = request.getParameter("tipoPubllico");
                                newLibro = new LibroNoFiccion(id, nombre, tipoLibro, autor, genero,  premiosLiterarios, areaTematica, tipoPublico);
                                ...
                                newLibro = new LibroReferencia(id, nombre, tipoLibro, autor, genero, premiosLiterarios, areaTematica, tipoPublico, campoAcademico, acceso);

                            }

                            if (newLibro != null) {
                                administrador.agregarLibro(newLibro);
                    ...
                    <form method="post" class="row g-3 " action="agregar.jsp">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-5">
                            ...
                            <select class="form-select" id="tipo_libro" name="tipo_libro" onchange="mostrarOpciones()" required>
                                <option value="">Selccione un tipo</option>
                        ...
                        <div id="div_terciario" class="row" style="display: none;">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="acceso" name="acceso" >
                                    ...
                                    <option value="Biblioteca">Consultado la biblioteca</option>
                                </select>
                                <div class="invalid-feedback">
                                    Debes completar este campo
                                </div>
                        ...
                        <div class="col-12 centrar">
                            <button id="btn_ registrarLibro" class="btn btn-primary" type="submit">Registrar Libro</button>
                        </div>
                    </form> 
                </div>
                <div class="col-md-3"></div>
