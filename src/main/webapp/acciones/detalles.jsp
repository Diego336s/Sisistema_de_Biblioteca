            ...
            <div class="row ">
                ...
                <div class="col-md-6 p-md-3 mb-4 rounded text-body-emphasis bg-body-secondary">
                    ...
                    <div  class="row">
                        ...
                        <div tipoLibro ="<%= libro.getTipoLibro()%>" id="div_primario" class="col-md-6">
                            <div >
                        ...
                        <div id="div_secundario" class="col-md-6" style="display:none;">
                            <div >
                        ...
                        <div id="div_terciario" class="col-md-6" style="display:none;">
                            <div >
                        ...
                        <div class="col-12 centrar">
                            <a href="listarLibros.jsp" class="btn btn-primary me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5"/>
                                </svg>
                            </a>
                            <a href="editar.jsp?id=<%= libro.getId()%>" class="btn btn-danger">
